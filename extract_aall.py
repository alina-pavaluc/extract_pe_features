...
class PEFileFeatures():
    ...
    def __init__(self):
        ...
        self.set_dense_features(
            ['check_sum', 'generated_check_sum', 'compile_date', 'debug_size', 'export_size', 'iat_rva',
             'major_version',
             'minor_version', 'number_of_bound_import_symbols', 'number_of_bound_imports', 'number_of_export_symbols',
             'number_of_import_symbols', 'number_of_imports', 'number_of_rva_and_sizes', 'number_of_sections',
             'pe_warnings',
    ...
    def extract_features_using_pefile(self, pe):
        ...
        datadirs = {0: 'IMAGE_DIRECTORY_ENTRY_EXPORT', 1: 'IMAGE_DIRECTORY_ENTRY_IMPORT',
...
if __name__ == "__main__":
    ...
    with open('featurescleanall.csv', mode='w', newline='') as feature_file:
        feature_writer = csv.writer(feature_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        feature_writer.writerow([my_extractor._dense_feature_list])
            ...
            for name in files:
                ...
                try:
                    ...
                    if file_type == "application/x-dosexec":
                        ...
                        feature_writer.writerow([my_extractor.extract_features_using_pefile(pe).values(),
                                                 'clean'])
